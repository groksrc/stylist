...
import 'client_new_model.dart';
export 'client_new_model.dart';

class ClientNewWidget extends StatefulWidget {
  const ClientNewWidget({Key? key}) : super(key: key);

  @override
  _ClientNewWidgetState createState() => _ClientNewWidgetState();
}

class _ClientNewWidgetState extends State<ClientNewWidget> {
  late ClientNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientNewModel());
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 20.0, 0.0, 20.0),
                          child: FlutterFlowDropDown<int>(
                            controller: _model.birthYearValueController ??=
                                FormFieldController<int>(
                              _model.birthYearValue ??= 2000,
                            ),
                            options: [2000],
                            optionLabels: ['2000'],
                            onChanged: (val) =>
                                setState(() => _model.birthYearValue = val),
                            width: 300.0,
                            height: 50.0,
                            textStyle: FlutterFlowTheme.of(context).bodyMedium,
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await ClientsTable().insert({
                                ...
                                'birth_year': _model.birthYearValue,
                              });
                            },
                            text: 'Save',
                            options: FFButtonOptions(
