  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ClientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClientsRow> clientClientsRowList = snapshot.data!;
        final clientClientsRow =
            clientClientsRowList.isNotEmpty ? clientClientsRowList.first : null;
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 20.0, 0.0, 0.0),
                            child: Text(
                              '${clientClientsRow?.firstName} ${clientClientsRow?.lastName}',
                          ...
                          if ((clientClientsRow!.birthMonth! > 0) &&
                              (clientClientsRow?.birthDay != null))
                            Row(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 10.0, 0.0, 0.0),
                                        child: Text(
                                          '${clientClientsRow?.birthMonth == 0 ? '' : clientClientsRow?.birthMonth?.toString()} / ${clientClientsRow?.birthDay?.toString()}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Poppins',
