                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'We will use your business name to create your free website for client bookings. We do not share or sell your information. For more information see our Privacy Policy on our website at https://highheelsavvy.com/privacy'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await StylistsTable().update(
                        data: {
                          'business_name': _model.businessNameController.text,
                        },
